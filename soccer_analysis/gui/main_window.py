...
try:
    ...
    try:
        from soccer_analysis.utils.tooltip import ToolTip, create_tooltip, TOOLTIP_DATABASE
...
try:
    ...
    try:
        from soccer_analysis.gui.tabs import (
            GalleryTab, RosterTab, EventDetectionTab, AnalysisTab,
            VisualizationTab, TrackingTab, AdvancedTab, RecognitionTab, MLTab
        )
    except ImportError:
...
class SoccerAnalysisGUI:
    ...
    def __init__(self, root):
        ...
        try:
            ...
            try:
                from soccer_analysis.utils.toast_notifications import ToastManager
                self.toast_manager = ToastManager(self.root)
            except ImportError:
    ...
    def open_playback_viewer(self):
        ...
        try:
            ...
            try:
                ...
                try:
                    from soccer_analysis.gui.viewers.playback_viewer import PlaybackViewer
                except ImportError:
                    # Legacy fallback
                    try:
    ...
    def open_setup_wizard(self):
        ...
        try:
            ...
            try:
                ...
                try:
                    from soccer_analysis.gui.viewers.setup_wizard import SetupWizard
                except ImportError:
                    # Legacy fallback
                    try:
